...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '7be3eb9488fa4470a0670097ce2f1b6c',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '人生是辽阔的旷野，而非笔直的轨道。',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'LILAC_X_youth', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'INFJ || 希望天天开心.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://liang-xinyi-0923.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'xyliang0923@163.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/Xinyi-Liang', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,wechat,qq,weibo,email,facebook,line,linkedin', // 分享的服務，按顺序显示,逗号隔开
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      ...
      artist: '坂本龙一',
      url: 'http://storage.live.com/items/93203DE15FE564A8%211277?filename%3dMr.Lawrence.mp3',
      cover:
            'https://i.postimg.cc/gcx1jXKr/A2889-B54-03-D3-4-E09-F8-FA-284-F6-DBDE18-C.jpg'
    },
  ],
  ...
  MUSIC_PLAYER_METING_ID:
        process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '9499545278', // 对应歌单的 id
